...
export const HOME_COPY = {
  kicker: '2026 Glass Console',
  title: "Compliance Operations for Malta's 2026 TCN Requirements",
  description:
    'Operate onboarding, vacancy evidence, and renewal controls from a single employer workspace built for audit traceability.',
}
...
export const COVERAGE_REGULATORY_SOURCES = [
  {
    name: 'Malta Labour Migration Policy (April 2024)',
    url: 'https://identita.gov.mt/wp-content/uploads/2024/03/Labour-Migration-Policy_Discussion-Document_EN.pdf',
    note: 'Primary policy baseline for current labour migration reforms.',
  },
  {
    name: 'Identità Malta',
...
export const SUPPORT_MESSAGE = `Need implementation support? Contact ${SITE_CONTACT_EMAIL}.`
